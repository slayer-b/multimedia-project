 ...
 */
public class Index {
    private final Sitemap child;
    private int index_num;
    private int index_files;

    private final File base;
    private FileWriter last_writer;
     ...
     * @param index_max max records in one sitemap file
    ...
    protected void addRecord(String loc) throws IOException {
        check();
