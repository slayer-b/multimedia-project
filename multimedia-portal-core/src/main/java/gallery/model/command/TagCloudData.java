...
public class TagCloudData implements IServiceBean{
	...
	public Object getData() {
		...
		List<String> tmp;
		for (String tag:tags){
			char firstLetter = Character.toLowerCase(tag.charAt(0));
			Character c;
	 ...
	 */
	public static class DataEntryComparator implements Comparator<String>, Serializable {

        private static final long serialVersionUID = 6521002195265329973L;
	 ...
	 * Compares two tags by score in descending order
	 */
	public static class DataEntryComparator2 implements Comparator<Character>, Serializable {

        private static final long serialVersionUID = -9209497708423586055L;
