...
//            return;
    ...
    @Required
    public void setDetailsKeepParameters(KeepParameters value) {
        this.detailsKeepParameters = value;
    }

    @Required
    public void setCategoryKeepParameters(KeepParameters value) {
        this.categoryKeepParameters = value;
    }

    @Required
    public void setContentMainUrl(String contentMainUrl) {
        this.contentMainUrl = contentMainUrl;
    }

    @Required
    public void setContentCategoryUrl(String contentCategoryUrl) {
        this.contentCategoryUrl = contentCategoryUrl;
    }

    @Required
    public void setContentDetailsUrl(String contentDetailsUrl) {
        this.contentDetailsUrl = contentDetailsUrl;
    }

    @Required
    public void setOptimizationMainUrl(String optimizationMainUrl) {
        this.optimizationMainUrl = optimizationMainUrl;
    }

    @Required
    public void setInfoTopMainUrl(String infoTopMainUrl) {
        this.infoTopMainUrl = infoTopMainUrl;
    }

    @Required
    public void setInfoBottomMainUrl(String infoBottomMainUrl) {
        this.infoBottomMainUrl = infoBottomMainUrl;
    }

    @Required
    public void setOptimizationDetailsUrl(String optimizationDetailsUrl) {
        this.optimizationDetailsUrl = optimizationDetailsUrl;
    }

    @Required
    public void setOptimizationCategoryUrl(String optimizationCategoryUrl) {
        this.optimizationCategoryUrl = optimizationCategoryUrl;
    }

    @Required
    public void setInfoTopCategoryUrl(String infoTopCategoryUrl) {
        this.infoTopCategoryUrl = infoTopCategoryUrl;
    }

    @Required
    public void setInfoBottomCategoryUrl(String infoBottomCategoryUrl) {
        this.infoBottomCategoryUrl = infoBottomCategoryUrl;
    }
}
