...
public class WallpaperTagCloudType extends AWallpaperType {
    ...
    @Required
    public void setKeepParameters(KeepParameters keepParameters) {
        this.keepParameters = keepParameters;
    }

    @Required
    public void setBindValidator(ABindValidator bindValidator) {
    ...
    @Required
    public void setOptimizationUrl(String optimizationUrl) {
        this.optimizationUrl = optimizationUrl;
    }

    @Required
    public void setInfoTopUrl(String infoTopUrl) {
        this.infoTopUrl = infoTopUrl;
    }

    @Required
    public void setInfoBottomUrl(String infoBottomUrl) {
        this.infoBottomUrl = infoBottomUrl;
    }
