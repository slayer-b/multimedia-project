...
public class StatisticsBean {
	 ...
	 */
	public synchronized void increaseStat(long time){increaseStat(time, 1L);}
	...
	public synchronized double getPercent_working(){return (total_time*100d)/(common.web.filters.StatisticFilter.getTime() - time_start);}
}
