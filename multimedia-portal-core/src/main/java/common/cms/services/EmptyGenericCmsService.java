...
/**
 * this class only logs every method invocation
 * and returns nulls
 * @author demchuck.dima@gmail.com
 */
public class EmptyGenericCmsService<T, ID extends Serializable> implements ICmsService<T, ID> {
	private final Logger logger = LoggerFactory.getLogger(EmptyGenericCmsService.class);
	...
	@Override
	public IMultiupdateBean<T, ID> getMultiupdateBean() {
