...
public interface IFilterService<T> {
	 ...
	 */
    List<T> getFilteredByPropertyValue(String propertyName, Object propertyValue);
	 ...
	 * @return list that matches given criteria
	 */
    List<T> getFilteredByPropertiesValue(String[] propertyName, Object[] propertyValue);
}
