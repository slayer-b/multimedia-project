...
public class CommonActions {
	...
	/**
	 * executes an update, serves as a template method that encapsulates common logic for update action
	...
	/**
	 * executes an update, serves as a template method that encapsulates common logic for delete action
