    ...
    public ModelAndView doInsert(HttpServletRequest req, HttpServletResponse resp/*, Pages command*/) {
        ...
        if ("insert".equals(action)) {
            if (res.hasErrors()) {
                ...
                PagesFolder pagesFolder = command.getPagesFolder();
                if (pagesFolder != null && pagesFolder.getId() == null) {
                    if (pagesFolder.getName() == null) {
                        command.setPagesFolder(null);
                    } else {
                        pagesFolder.setPages(command);
                    }
                }
