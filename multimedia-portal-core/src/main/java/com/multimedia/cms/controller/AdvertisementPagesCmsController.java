 ...
 */
@Controller("advertisementPagesCmsController")
@RequestMapping("/cms/advertisementPages/index.htm")
public class AdvertisementPagesCmsController extends AGenericPagesCmsController<AdvertisementPages>{
	private final List<String> filterProperties = Arrays.asList("id_advertisement_nav", "id_pages_nav");
	private final List<String> filterAliases = Arrays.asList("this.id_advertisement", "this.id_pages");
