 ...
 */
@Controller("advertisementCmsController")
@RequestMapping("/cms/advertisement/index.htm")
public class AdvertisementCmsController extends SimpleGenericCmsController<Advertisement>{
