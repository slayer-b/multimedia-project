...
import com.multimedia.dao.WallpaperCommentDAO;
 ...
 */
@Service("wallpaperCommentService")
public class WallpaperCommentServiceImpl extends GenericServiceImpl<WallpaperComment, Long> {

    @Autowired
    public WallpaperCommentServiceImpl(WallpaperCommentDAO wallpaperCommentDAO) {
        super(wallpaperCommentDAO);
    }
