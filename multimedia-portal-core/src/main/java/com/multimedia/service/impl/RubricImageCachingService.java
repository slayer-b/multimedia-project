...
public class RubricImageCachingService implements IRubricImageService {
    ...
    public boolean refreshImages(Long id) {
        ...
        if (id==null) {
            pages = pagesService.getByPropertyValueOrdered(PAGES_NAMES, "type", WallpaperGalleryType.TYPE, null, null);
        } else {
            pages = pagesService.getByPropertyValueOrdered(PAGES_NAMES, "id", id, null, null);
        }
