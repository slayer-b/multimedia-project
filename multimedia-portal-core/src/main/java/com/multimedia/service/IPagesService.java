...
public interface IPagesService extends IGenericService<Pages, Long> {
	 ...
	 * @return the pages object
	 */
	List<Pages> getShortOrderedByPropertyValueCms(String propertyName, Object propertyValue);
     ...
     *3  adds first record to result (as r0)
	 ...
	 */
	List<Pages> getPagesForRelocate(Long id);
     ...
     */
    boolean relocatePages(Long id,Long newIdPages);
	 ...
	 */
	List<Pages> getAllPagesParents(Long id, String[] property_names);
	 ...
	 */
	List<Pages> getCategories(Long id, String type);

    /**
     * if one of parameters is null, its not used
     * @return list of pages that can be used for choosing from combobox
     */
    List<Pages> getAllCombobox(Boolean active, Boolean last, String type);

	/**
     * the result is sorted by sort and name columns works as follows
     *1  selects all pages where id_pages=id
     *2  adds first record to result (as r0)
	 ...
	 * @param submodules set of types that will be activated
	 * @return all found submodules
	 */
	List<Pages> activateSubmodules(List<Pages> navigation, Map<String, ASubmodule> submodules);
	 ...
	 * @param id page id
	 */
	void recalculateLast(Long id);

    List<Pages> getPagesChildrenRecurciveOrderedWhere(String[] properties, String[] propertyNames, Object[][] propertyValues);
    List<Pages> getPagesChildrenRecurciveOrderedWhere(String[] properties, String[] propPseudonyms, String[] propertyNames, Object[][] propertyValues);
    List<Pages> getPagesChildrenRecurciveOrderedWhere(String[] properties, String[] propPseudonyms, String[] propertyNames, Object[][] propertyValues, Long first_id);
