...
<form:form method="post" commandName="command" action="?do=update&id_pages_nav=${param['id_pages_nav']}" >
<table align="center">
	...
	<form:hidden path="id"/>
	<tr><td align="center"><form:errors path="id"/></td></tr>
    ...
    <tr><td align="center"><table>
		<form:hidden path="pagesFolder.id"/>
		<tr><td class=bold>Папка&nbsp;*:&nbsp;<form:errors path="pagesFolder.name" cssClass="error_msg"/><br></td></tr>
		<tr><td align="center">
			<form:input path="pagesFolder.name" cssClass="long_text_area"/>
		</td></tr>
    </table></td></tr>
    <tr align="right"><td>
		<a class="link" href="index.htm?id_pages_nav=${param['id_pages_nav']}">[Назад]</a>
