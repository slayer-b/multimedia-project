...
<div align=center class="form_head">Редактировать wallpaper</div><br>
<div align=center>* - обязательно заполнить</div>
<%@ include file="../../messages/error.jsp"%>
<%@ include file="../../messages/help.jsp"%>

<form:form action="?do=update&id_pages_nav=${param['id_pages_nav']}" method="post" commandName="content_data" enctype="multipart/form-data">

<input type=hidden name="action" value="update"/>
<form:hidden path="id"/>
<form:hidden path="date_upload"/>
<form:hidden path="views"/>
<form:hidden path="width"/>
<form:hidden path="height"/>

<table align="center">
	<tr><td align="center"><a class="link" href="${pageContext.servletContext.contextPath}/images/wallpaper/full/${content_data.folderAndName}" target="_blank"><img alt="${content_data.name}" src="${pageContext.servletContext.contextPath}/images/wallpaper/medium/${content_data.folderAndName}"></a></td></tr>
    ...
    <tr><td align="center"><table>
		<tr><td class=bold><a class="link" href="${pageContext.servletContext.contextPath}/images/wallpaper/full/${content_data.folderAndName}">Фото</a>:&nbsp;<form:errors path="content" cssClass="error_msg"/><br></td></tr>
...
<div align="center"><a target="_blank" href="${pageContext.servletContext.contextPath}/index.htm?id_pages_nav=${content_data.id_pages}&amp;id_photo_nav=${content_data.id}">Перейти к обоям</a></div>