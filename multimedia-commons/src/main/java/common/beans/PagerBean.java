...
public class PagerBean {
    ...
    public void setItemsCount(int itemsCount) {
        if (itemsCount < 0) {
            throw new IllegalArgumentException("Property itemsCount may not be negative.");
        }
    ...
    /**
     * @return a part of uri that will be added for each href in pager
     */
    ...
    public int getNavButtonsCount() {
        return 2 * navButtonsCountOneSide + 1;
    }

    /**
     * @return quantity of buttons drawn in one side of cur page
     */
    public int getNavButtonsCountOneSide() {
        return navButtonsCountOneSide;
    }

    /**
     * @param value quantity of buttons drawn in one side of cur page
     */
    public void setNavButtonsCountOneSide(int value) {
        this.navButtonsCountOneSide = value;
    }
