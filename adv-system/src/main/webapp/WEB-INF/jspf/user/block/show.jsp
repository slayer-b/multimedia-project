...
<form id="form_1" method="post" action="?do=multi_update&amp;action=multi_update${keep_parameters}">
    ...
    <table align="center" border="1" cellpadding="2" cellspacing="0" style='border-collapse: collapse;'>
        ...
        <tr class="form_head_row">
            <td width="30px"><input title="Снять/установить отметку у всех" type="checkbox" id="check_all_box"
                                    onclick="reset_all(prefixes,'check_all_box',count);" checked></td>
            <td align="left" width="30px">ID</td>
            <td align="center" width="150px">pub_id</td>
            <td align="center" width="150px">name</td>
            <td align="center" width="70">Посмотреть</td>
        ...
        <c:forEach items="${content_data}" var="row" varStatus="i">
            ...
            <tr class="${tr_class}">
                ...
                <td>${row.name}</td>
                <td align="center">
                    <a href="location.htm?do=view&amp;id_block=${row.id}&amp;page_number=${page_number}${keep_parameters}"
                       title="где показывается блок">места</a>
                </td>
                <td align="center">
